...
def createParser():
    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter,
                                     description="3DPredictor: A tool for 3D chromatin structure prediction.",
                                     epilog="GitHub: https://github.com/labdevgen/3Dpredictor")
    ...
    Default_parser.add_argument('-g', '--ctcf_genome_assembly', required=True, dest="genome_assembly",
...
if __name__ == '__main__':
    ...
    RNA_seq_file = "Z:/scratch/202002281332polina_data_2019/3DPredictor/input/NPC/RNA-seq/GSM2533845_NPC_rep1.txt"
    CTCF_file = namespace.CTCF_file
    CTCF_file = "Z:/scratch/202002281332polina_data_2019/3DPredictor/input/NPC/CTCF/NPC_WT_DpnII_ppr.IDR0.05.filt.narrowPeak"
    # CTCF_orient_file = namespace.CTCF_orient_file
    # chr = namespace.chr
    chr = 12
    interval_start = 2000000
    interval_end = 2002000
    resolution = 5000
